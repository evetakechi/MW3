<?php
//Takes single 'id' query param agrument and returns its
//associated data as HTML, or ,if called via XmlHttpRequest,
...
//If not, then send it back as a list in an HTNL document.
...
<div data-role="page" data-add-back-btn="true">
	<div data-role="header"><h1><?php if (  $category_obj ) {echo $category_obj['name']; } else { echo "No Match"; } ?>
    </h1></div>
...
?>
	<p><?php echo $category_object['description']; ?>
</p>
